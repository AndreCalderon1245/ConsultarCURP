...
if (isset($_GET["searchDP"])) {
    ...
    $query = "SELECT * FROM tbl_curp INNER JOIN tbl_person ON tbl_curp.id_person = tbl_person.id WHERE tbl_person.name = '$name' AND tbl_person.surname = '$surname' AND tbl_person.second_surname = '$second_surname' AND tbl_person.gender = '$gender'";
            ...
            <form>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select mb-3" id="input-estado" required>
                            <option value="">Seleccione</option>
